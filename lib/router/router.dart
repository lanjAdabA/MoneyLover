...
import 'package:moneylover/pages/allrecents.page.dart';
import 'package:moneylover/pages/home.page.dart';
import 'package:moneylover/pages/info.page.dart';
...
import 'package:moneylover/pages/updatetransaction.page.dart';
...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    AutoRoute(page: InfoDetailPage),
    AutoRoute(page: AllRecentsPage),
    AutoRoute(page: UpdateTransactionPage),
  ],
)
class $AppRouter {}
